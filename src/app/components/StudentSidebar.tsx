    ...
    <>
      ...
      <nav className={`sidebar${collapsed ? " collapsed" : ""}${isMobile && !collapsed ? " mobile-open" : ""}`}>
        ...
        <div className="nav-group">
          ...
          <Link href="/student/settings" className={`nav-item${activePage === "settings" ? " active student-active" : ""}`} onClick={closeMobileSidebar}>
            <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        ...
        <div className="nav-group">
          ...
          <Link href="/student/institution" className={`nav-item${activePage === "institution" ? " active student-active" : ""}`} onClick={closeMobileSidebar}>
            <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        ...
        <div className="sidebar-user">
          <div className="avatar ak" style={{ background: '#059669' }}>
            {user ? `${user.first_name?.[0] || ''}${user.last_name?.[0] || ''}`.toUpperCase() : 'S'}
          </div>
