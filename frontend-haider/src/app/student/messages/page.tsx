...
const teachers = [
  { id: 1, name: "Ms. Rita Sharma", initials: "RS", color: "var(--blue)", lastMsg: "Hello Aryan, have you finished the assignment?", time: "10:30 AM", status: "online" },
  { id: 2, name: "Mr. Ramesh Kumar", initials: "RK", color: "var(--orange)", lastMsg: "Please check the new notes I uploaded.", time: "9:45 AM", status: "offline" },
  { id: 3, name: "Mrs. Sunita Gupta", initials: "SG", color: "var(--purple)", lastMsg: "Good job on the last test!", time: "Yesterday", status: "online" },
];

const initialMessages = [
  { id: 1, senderId: 1, text: "Hello Aryan, have you finished the assignment?", time: "10:30 AM", isMe: false },
  { id: 2, senderId: 0, text: "Not yet Ma'am, I'm working on Chapter 5.", time: "10:31 AM", isMe: true },
  { id: 3, senderId: 0, text: "I have a small doubt in the second question.", time: "10:32 AM", isMe: true },
  { id: 4, senderId: 1, text: "Sure, ask your doubt. I'm here to help.", time: "10:35 AM", isMe: false },
];

export default function StudentMessages() {
  const [searchTerm, setSearchTerm] = useState("");
  const [activeChat, setActiveChat] = useState(teachers[0]);
              ...
              filteredTeachers.map(teacher => (
                <div 
                  ...
                  style={{ 
                    ...
                    padding: '16px 24px', 
                    cursor: 'pointer',
                    background: activeChat.id === teacher.id ? 'var(--blue-light)' : 'transparent',
                    borderLeft: activeChat.id === teacher.id ? '4px solid var(--blue)' : '4px solid transparent',
                    transition: 'all 0.2s',
                    position: 'relative'
                  }}
                >
                  <div style={{ position: 'relative' }}>
                    <div className="avatar" style={{ background: teacher.color }}>{teacher.initials}</div>
                    <div style={{ 
                      position: 'absolute', 
                      bottom: '0', 
                      right: '0', 
                      ...
                      height: '12px', 
                      borderRadius: '50%', 
                      background: teacher.status === 'online' ? 'var(--green)' : '#CBD5E1', 
                      border: '2px solid white' 
                    }} />
                  </div>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
                      <div style={{ fontWeight: 600, fontSize: '14px', color: 'var(--text-primary)' }}>{teacher.name}</div>
                      <div style={{ fontSize: '11px', color: 'var(--text-meta)' }}>{teacher.time}</div>
                    </div>
